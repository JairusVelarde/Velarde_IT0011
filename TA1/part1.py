...
#output
print("Number of Vowels:", vowel , end = '')
print("Number of Consonants:",consonant , end = '')
print("Number of Numbers:",number, end = '')
print("Number of Spaces:",space)
print("Number of Special Characters:",other, end = '')